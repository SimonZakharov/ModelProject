...
namespace ModelProject
{
    class ModelEngine : Engine
    {
        ...
        public override void SetTOverheat(double val)    {   TOverheat = val;    }
        ...
        public ModelEngine(string filename)
        {
            try
            {
        ...
        public ModelEngine(double i, double to, double hm, double hv, double c, Dictionary<double, double> keyValuePairs)
        {
            I = i;
            Hm = hm;
            Hv = hv;
        ...
        /// <returns></returns>
        public static bool TryReadEngine(out ModelEngine engine, string source)
        {
            ...
            if (string.Equals(source, "console"))
            {
                try
                {
                    ...
                    engine = new ModelEngine(i, to, hm, hv, c, keyValuePairs.OrderBy(key => key.Key).ToDictionary((keyItem) => keyItem.Key, (valueItem) => valueItem.Value));
                    return true;
                }
        ...
        public override Tuple<int, double> StartEngine(double outerTemperature, string target = "console")
        {
